        ...
        <div class="row">
            ...
            <div class="affichage col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="card_container"
                    onclick="window.location='/single.php?idProduit=<?php echo $unproduit['id']; ?>'">
                    <div class="card">
                        <!-- IMAGE DU PRODUIT  -->
                        <?php ?>
                        <div class="img-card-hover">
                            ...
                            <div class="card_hover">
                                ...
                                <div class="icon_hover">
                                    <a href="/single.php?idProduit=<?php echo $unproduit['id']; ?>">
                    ...
                    $res_taille= $dbh->prepare("SELECT * FROM produittaille where idProduit =".$unproduit['id']);
                            ...
                            <!-- AVIS PRODUIT  -->
                            <p><?php echo getNumberAvis($unproduit['id']); ?></p>
